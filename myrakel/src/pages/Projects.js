...
const Projects = () => {
    ...
    return (
        ...
        <div className="container px-4 px-lg-5">
            ...
            <div className={`${styles.projectcontainer} row gx-0 mt-5 mb-lg-0 justify-content-center`}>
                    ...
                    <div className="text-center h-100 project">
                        <div className="d-flex h-100">
                            <div data-aos="zoom-in" data-aos-duration="1000" className={`${styles.projecttext} w-100 my-auto text-center text-lg-left`}>
                                <h4>Minimalistisk</h4>
                                <p className="mb-0">En tavelstil för dig som vill ha ett enkelt stilrent intryck. När jag målar den här typen av tavlor gillar jag att jobba med struktur för att få till ett liv i konstverket.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className={`${styles.projectcontainer} row gx-0 mt-5 mb-lg-0 justify-content-center`}>
                ...
                <div className='col-lg-6 order-lg-first'>
                    <div>
                        <div className="d-flex h-100">
                            <div data-aos="zoom-in" data-aos-duration="1000" className={`${styles.projecttext} w-100 my-auto text-center text-lg-right`}>
                                <h4>Svepande</h4>
                                <p className="mb-0">Den svepande tavlan skapar jag genom flera lager av färg för att få till djupet, samt genom noga utvalda kulörer som harmoniserar med varandra.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className={`${styles.projectcontainer} row gx-0 mt-5 mb-lg-0 justify-content-center`}>
                ...
                <div className="col-lg-6">
                    <div className="text-center h-100 project">
                        <div className="d-flex h-100">
                            <div data-aos="zoom-in" data-aos-duration="1000" className={`${styles.projecttext} w-100 my-auto text-center text-lg-left`}>
                                <h4>Abstrakt Landskap</h4>
                                <p className="mb-0">Dessa tavlor föreställer landskap i fantasin, ibland mer tydliga sådana och ibland gillar jag att skapa landskap som är mer diffusa och som varje åskadare ser på olika sätt.</p>
                            </div>
                        </div>
                    </div>
                </div>
